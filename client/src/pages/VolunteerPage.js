...
const VolunteerPage = () => {
    ...
    const deleteIndvVolunteer = async (volunteerId) => {
        try {
    ...
    return (<div className='volunteer'>
      ...
      <div className='volunteer-list'>
        {volunteers ? volunteers.map((volunteer) => (<VolunteerCard key={volunteer.id} id={volunteer.id} name={volunteer.volunteerName} deleteIndvVolunteer={deleteIndvVolunteer}/>)) : (<div>
